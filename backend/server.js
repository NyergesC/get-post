...
/* const http = require('http'); //require fv es at van adva egy string http
const fs = require('fs'); //fs string van atadva argumentumkent
const path = require('path');
	...
	if(err){
		...
		fs.readFile(filePath, (err, data) => {
			if(err) {
				...
				console.log("index html rendben kiszolgalodott")
				res.end(data);
			}
		});
	}
